...
import org.graces.mydsl.generator.MyDslGenerator;
import org.graces.mydsl.parser.antlr.MyDslAntlrTokenFileProvider;
import org.graces.mydsl.parser.antlr.MyDslParser;
import org.graces.mydsl.parser.antlr.internal.InternalMyDslLexer;
import org.graces.mydsl.scoping.MyDslScopeProvider;
import org.graces.mydsl.serializer.MyDslSemanticSequencer;
import org.graces.mydsl.serializer.MyDslSyntacticSequencer;
import org.graces.mydsl.services.MyDslGrammarAccess;
import org.graces.mydsl.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/graces/mydsl/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.graces.mydsl.MyDsl");
	}
